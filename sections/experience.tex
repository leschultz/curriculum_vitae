...
\begin{itemize}
    ...
    \item \textbf{Bayesian Optimization:} Screened metal-organic frameworks with graph neural network surrogates for favorable seperation properties of volitie organic compounds.
\end{itemize}
