...
\noindent \textbf{Postdoctoral Appointee \hfill Dec 2024 --- Present}\\
Center for Integrated Nanotechnologies, Sandia National Laboratories \dotfill Albuquerque, NM

\begin{itemize}
    \item \textbf{Graph Neural Networks:} Built graph neural networks to predict metal-organic framework properties with uncertainty estimates.  
    \item \textbf{Bayesian Optimization:} Screened metal-organic frameworks with graph neural network surrogates for favorable separation properties of volatile organic compounds.
    \item \textbf{Microstructure Screening:} Screened LLZO microstructures using Bayesian optimization to identify solid electrolytes with favorable properties.
    \item \textbf{Surface Binding Energies:} Analyzed how surface orientation impacts binding energies and their downstream effects on sputtering.
\end{itemize}
